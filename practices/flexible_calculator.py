...
# **info collects extra instructions, like the operation, into a dictionary
def calculator(*numbers, **info):# *numbers collects all numbers the user gives into a tuple
    ...
    if operation == "product":
        ...
        product = 1
        for n in numbers:
            # Multiply product by this number
            product *= n
        return product

    return "idk that operation, lo siento"  # if user typed something wrong
